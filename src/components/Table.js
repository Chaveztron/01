...

                    {
                      headCells.map((propiedad, i) => {
                        ...
                        //console.log(row.propi)
                          if (i === 1) {
                            return   <TableCell key={`id_${row[propi]+i*index}`} component="th" id={labelId} scope="row" padding="none">{row[propi]}</TableCell>
                          }else{
                          return  <TableCell key={`id_${row[propi]+i*index}`} align="right">{row[propi]}</TableCell>;
                        }
                      })
                    }
